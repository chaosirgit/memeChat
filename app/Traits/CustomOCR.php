...
class CustomOCR extends OCR
{
    const ERROR_INFO = [
        ...
        16451 => '营业执照OCR识别失败,请尝试更换有效的营业执照图片',
     ...
     * @return mixed
     */
    public function request(string $url, string $image, array $options = [])
    {
        ...
        if ($result['ret'] !== 0) {
            throw new Exception(self::ERROR_INFO[$result['ret']]??'未知错误',$result['ret']);
        }
